      ...
      <tbody>
        {subjects.map((subject, index) => (
          <tr key={index}>
            ...
            <td>
              {editIndex === index ? (
                <button className="btn save" onClick={() => handleSaveClick(subject.id)}>
                  Save
                </button>
              ) : (
                <button className="btn edit" onClick={() => handleEditClick(index, subject.score)}>
                  Edit
                </button>
              )}
              <button className="btn delete" onClick={() => deleteSubject(subject.id)}>Delete</button>
            </td>
          </tr>
        ))}
      </tbody>

    ...
    <div>
      ...
      >
        <div className="text-center text-white p-6 rounded-lg bg-black bg-opacity-50">
          <h1 className="text-5xl font-bold">Welcome to UserCentral Platform</h1>
          <p className="mt-4 text-lg">
            Predict and improve your academic performance with intelligent tools.
          </p>
          <button className="mt-6 bg-blue-500 text-white px-6 py-2 rounded hover:bg-blue-600" onClick={() => window.location.href='/register'}>
            Get Started
          </button>
        </div>
      </section>
      ...
      <section id="features" className="py-16 bg-white px-6">
        <h2 className="text-3xl font-bold text-center mb-8 text-blue-500">Key Features</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-start">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 mt-2">
              Connect with specialized groups to access tailored educational resources.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="about" className="py-16 bg-gray-50 text-center px-6">
        <h2 className="text-3xl font-bold mb-4 text-blue-500">About the Application</h2>
      ...
      <section id="testimonials" className="py-16 bg-white px-6">
        <h2 className="text-3xl font-bold text-center mb-8 text-blue-500">What Our Users Say</h2>
